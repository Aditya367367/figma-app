    ...
    <footer className=" lg:bg-transparent text-black lg:mt-[150px] lg:bg-[#F6F3FF] lg:container lg:mx-auto">
      <div className="container mx-auto px-4 lg:ml-[500px]">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 text-center lg:text-left relative">
         ...
         {/* Bottom Branding */}
      <div className="  w-[400px] h-[57px] mt-[-50px] ml-[1150px]   items-center justify-right hidden lg:flex ">
        <Image src={brand2} alt="brand2"/>
      </div>
   
        {/* Bottom Branding */}
      <div className=" bottom-0 left-0 w-[400px] h-[57px] mt-[50px] ml-[-20px] flex items-center justify-center bg-[#673CCB] lg:hidden ">
